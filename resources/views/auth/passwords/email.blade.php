                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-xs-12 col-sm-12 col-md-10 col-md-push-1 col-lg-6 col-lg-push-3">
                            ...
                            <div class="jf-logindetails">
                                ...
                                @endif
                                <form method="POST" action="{{ route('password.email') }}" class="jf-formtheme jf-formlogin">
                                    @csrf
                                   	<fieldset>
                                        <div class="form-group jf-inputwithicon">
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" placeholder="E-Mail Address" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                            @error('email')
                                        ...
                                        <div class="form-group jf-btnsarea">
                                            <button type="submit" class="jf-btn jf-active btn-primary" style="width:100%">{{ __('Send Password Reset Link') }}</button>
                                        </div>
                                    </fieldset>
                                </form>
                            </div>
