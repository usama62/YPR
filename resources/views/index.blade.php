...
<script>
	$(document).ready(function() {
		...
		$("#jf-health").click(function() {
			// console.log("clicked");
			$.ajax({ 
				url: "{{ route('getcategoriesforfrontend') }}",
				data: {_token : _token,data:'health'},
				type: 'post',
		...
		$("#jf-disease").click(function() {
			$.ajax({ 
				url: "{{ route('getcategoriesforfrontend') }}",
				data: {_token : _token,data:'disease'},
				type: 'post',
				success: function(response)
				{
		...
		$("#jf-drugs").click(function() {
			$.ajax({ 
				url: "{{ route('getcategoriesforfrontend') }}",
				data: {_token : _token,data:'drugs'},
				type: 'post',
				success: function(response)
				{
					category = JSON.stringify(response['category']);
						...
						<form action="{{ route('search') }}" class="jf-formtheme jf-formbannersearch" >
							<fieldset class="jf-searchoptions">
								<div class="form-group">
									<div class="jf-radio jf-findjobs jf-search-type" id="jf-health" data-class="js-job">
										<input type="radio" name="radio">
										<label for="jf-findjobs">Health</label>
									</div>
									<div class="jf-radio jf-employers jf-search-type" id="jf-disease" data-class="js-employer">
										<input type="radio" name="radio">
										<label for="jf-employers">Disease</label>
									</div>
									<div class="jf-radio jf-candidates jf-search-type" id="jf-drugs" data-class="js-candidate">
										<input type="radio" name="radio">
							...
							<fieldset class="jf-searcharea">
								...
								<div class="jf-searchholder">
									<span class="jf-select">
										<select data-placeholder="All" id="option" class="chosen-select locations" name="category">
