					...
					<div class="jf-dbsectionspace jf-haslayout">
						<div class="jf-dashboardbox">
							...
							<div class="jf-dashbboardcontent">
								<form method="POST" action="{{ route('page.store') }}" enctype="multipart/form-data" class="jf-formtheme jf-postajobform" >
								@csrf
									<fieldset>	
										...
										@endif 
										<div class="form-group jf-inputwithicon">
											<textarea type="text" name="description" placeholder="Enter Content"></textarea>
										</div>
