                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="jf-dashboardbox jf-myappliedjobs">
                        <div class="jf-dashboardboxtitle jf-dashboardboxtitlevtwo">
                            ...
                            <form class="jf-formtheme jf-questsearch" action="{{ route('disease.search') }}">
                                <fieldset>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul class="jf-btnjobalerts jf-btnjobalertsvtwo">
                                        ...
                                        <li class="jf-btndell"><a onclick="return confirm('Are you sure?')" href="{{ route('disease.delete',['id'=>$post->id]) }}" ><i class="ti-trash"></i></a></li>
                                    </ul>
