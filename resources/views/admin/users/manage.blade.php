				...
				<div class="col-12 col-sm-12 col-md-12 col-lg-12">
					<div class="jf-dashboardbox jf-myappliedjobs">
						<div class="jf-dashboardboxtitle jf-dashboardboxtitlevtwo">
							...
							<form class="jf-formtheme jf-questsearch" action="{{ route('user.search') }}">
                                <fieldset>
							...
							<ul>
								...
								<li>
									...
									<!-- <li class="jf-btnnewwindow"><a href="javascript:void(0);"><i class="ti-new-window"></i></a></li> -->
										...
										<li class="jf-btndell"><a onclick="return confirm('Are you sure?')" href="{{ route('user.delete',['id'=>$user->id]) }}"><i class="ti-trash"></i></a></li>
									</ul>
