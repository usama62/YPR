                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="jf-dashboardbox jf-myappliedjobs">
                        <div class="jf-dashboardboxtitle jf-dashboardboxtitlevtwo">
                            ...
                            <form class="jf-formtheme jf-questsearch" action="{{ route('health.search') }}">
                                <fieldset>
                        ...
                        <div class="jf-dashbboardcontent jf-myjobsapplications">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <li class="jf-btnnewwindow"><a href="{{ route('health.detail',['id'=>$post->id]) }}"><i class="ti-new-window"></i></a></li>
                                        <li class="jf-btneditjob"><a href="{{ route('health.edit',['id'=>$post->id]) }}"><i class="ti-pencil"></i></a></li>
                                        <li class="jf-btndell"><a onclick="return confirm('Are you sure?')" href="{{ route('health.delete',['id'=>$post->id]) }}"><i class="ti-trash"></i></a></li>
                                    </ul>
