...
@section('content')
					...
					<div class="jf-dbsectionspace jf-haslayout">
						<div class="jf-dashboardbox">
							...
							<div class="jf-dashbboardcontent">
								<form method="POST" action="{{ route('drugs_brand.store') }}" enctype="multipart/form-data" class="jf-formtheme jf-postajobform" >
								@csrf
									<fieldset>	
	...
	<script>
		$("#add_btn").click(function(){
			...
			if(val != ""){
				$("#show_brand_type").append(" <div class='newbrand minibox'>"+ val +"<button type='button' class='close'>&times;</button></div>");
