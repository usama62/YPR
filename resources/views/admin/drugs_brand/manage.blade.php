...
@section('content')
    <div id="jf-dashboardbanner" class="jf-dashboardbanner">
        ...
        <ol class="jf-breadcrumb">
            ...
            <li><a href="javascript:void(0);">Drugs Brands</a></li>
        </ol>
    </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="jf-dashboardbox jf-myappliedjobs">
                        <div class="jf-dashboardboxtitle jf-dashboardboxtitlevtwo">
                            <div class="jf-title">
                                <h2>Drugs Brands</h2>
                                <span>Your Latest Drugs Brands</span>
                            </div>
                            <form class="jf-formtheme jf-questsearch" action="{{ route('drugs_brand.search') }}">
                                <fieldset>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul class="jf-btnjobalerts jf-btnjobalertsvtwo">
                                        ...
                                        <li class="jf-btndell"><a onclick="return confirm('Are you sure?')" href="{{ route('drugs_brand.delete',['id'=>$post->id]) }}"><i class="ti-trash"></i></a></li>
                                    </ul>
